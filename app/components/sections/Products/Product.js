...
export const Product = ({ item, offer = false }) => {
  ...
  return (
    <div className="relative overflow-hidden h-[295px] w-[195px] md:h-[300px] md:w-[245px] lg:h-[370px] lg:w-[280px] transition-all duration-300 shadow-md p-2">
      <div className="relative py-4 bg_four rounded-md border-[1px] border-transparent flex justify-center items-center  flex-col  hover:border-main-clr">
        {/* offer */}
        {offer && (
