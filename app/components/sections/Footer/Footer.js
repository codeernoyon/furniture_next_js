...
function Footer() {
  const { Information, Service } = FooterN;
  return (
    <footer className="pt-10 min-h-[50vh] lg:h-[50vh] grid md:grid-cols-2 px-2 md:px-5 bg lg:flex justify-center items-center">
      {/* left */}
      ...
      <FooterNav title={"Customer Service"} items={Service} />
